...
% =========================================================================
    ...
    % -- MAIN FIGURE --
    fig = figure( ...
        'Name',        'IISE Image Analyzer PRO v3.0 - TP7 OTSU & K-Means', ...
        'Units',       'normalized', ...
    ...
    uicontrol('Style', 'text', 'Parent', fig, 'Units', 'normalized', ...
        ...
        'String', '  >> IISE IMAGE ANALYZER PRO  |  v3.0  |  TP7: OTSU & K-Means', ...
...
% =========================================================================
    ...
    function cb_otsu_analyse(~, ~)
        ...
        aFig = figure('Name', 'TP7 - Analyse OTSU Complete', ...
            'Color', C.bgLight, ...
        ...
        uicontrol('Style', 'text', 'Parent', aFig, ...
            ...
            'String', '  TP7 - Algorithme OTSU  |  Analyse Complete  |  Pr. Y. AIT LAHCEN', ...
        ...
        title(ax1, 'Image Originale (Gris)', 'FontSize', 9, 'Color', C.mainBlue, 'FontWeight', 'bold');
        axis(ax1, 'off');

        % -- Axes 2: Segmented image --
        ax2 = axes('Parent', aFig, 'Units', 'normalized', 'Position', [0.27 0.52 0.21 0.38]);
        imshow(seg_result, 'Parent', ax2);
        title(ax2, sprintf('Image Segmentee (T=%d)', S.otsu.T), ...
